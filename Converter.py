...
class Converter:
    ...
    def to_nparray(self, img, mode=BIN_MODE, bcolor=(0, 0, 0), eps=10, vectorize=False):
    ...
    def to_bwimage(self, arr, name, mode):
    ...
    def to_range(self, img, left, right):
        data = np.asarray(Image.open(img)).sum(axis=2)/3
